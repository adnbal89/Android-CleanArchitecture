 ...
 */
package com.adnanbal.fxdedektifi.forex.test.view.activity;
...
public class UserDetailsActivityTest extends ActivityInstrumentationTestCase2<UserDetailsActivity> {
  ...
  public void testLoadUserHappyCaseViews() {
    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.rl_retry))
        .check(matches(not(isDisplayed())));
    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.rl_progress))
        .check(matches(not(isDisplayed())));

    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.tv_fullname))
        .check(matches(isDisplayed()));
    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.tv_email))
        .check(matches(isDisplayed()));
    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.tv_description))
        .check(matches(isDisplayed()));
  }
  ...
  public void testLoadUserHappyCaseData() {
    ...
    onView(ViewMatchers.withId(com.adnanbal.fxdedektifi.forex.presentation.R.id.tv_followers))
