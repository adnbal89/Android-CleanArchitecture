...
import com.adnanbal.fxdedektifi.forex.data.exception.FirebaseRxDataCastException;
import com.adnanbal.fxdedektifi.forex.data.exception.FirebaseRxDataException;
...
public class RxFirebase {
  ...
  @NonNull
  public static <T> Observable<T> getObservableForSingleEvent(@NonNull final Query query,
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
          ...
          public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (value != null) {
              ...
              if (!emitter.isDisposed()) {
                emitter.onError(new FirebaseRxDataCastException(
  ...
  @NonNull
  public static <T> Observable<T> getObservable(@NonNull final Query query,
      @NonNull final Class<T> clazz) {
    return Observable.create(new ObservableOnSubscribe<T>() {
      @Override
      public void subscribe(final ObservableEmitter<T> emitter) throws Exception {
