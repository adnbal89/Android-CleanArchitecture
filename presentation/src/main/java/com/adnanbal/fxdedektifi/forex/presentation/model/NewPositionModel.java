...
public class NewPositionModel {
  ...
  public NewPositionModel() {
    //empty constructor for Gson Mapper
  }

  public NewPositionModel(String id, String pair, double volume, boolean buy_sell,
  ...
  public NewPositionModel(String pair, double volume, boolean buy_sell,
      double openingPrice, boolean open, String status, String comment, Map<String, String> date,
      Double take_profit_price, Double stop_loss_price, boolean hitStopLoss,
      boolean hitTakeProfit) {
    this.pair = pair;
  ...
  public NewPositionModel(String id) {
    this.id = id;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewPositionModel that = (NewPositionModel) o;
