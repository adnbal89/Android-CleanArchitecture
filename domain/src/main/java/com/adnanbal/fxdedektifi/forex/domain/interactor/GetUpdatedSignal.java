...
public class GetUpdatedSignal extends UseCase<Signal, Void> {
  ...
  @Inject
  GetUpdatedSignal(SignalRepository signalRepository, ThreadExecutor threadExecutor,
  ...
  @Override
  Observable<Signal> buildUseCaseObservable(Void aVoid) {
    return this.signalRepository.getUpdatedSignal();
  }
}
