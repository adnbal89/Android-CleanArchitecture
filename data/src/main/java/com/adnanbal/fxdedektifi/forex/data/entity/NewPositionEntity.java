...
public class NewPositionEntity {
  ...
  public NewPositionEntity() {
    //empty constructor for Gson Mapper
  }

  public NewPositionEntity(String id, String pair, double volume, boolean buy_sell,
  ...
  public NewPositionEntity(String pair, double volume, boolean buy_sell,
      double openingPrice, boolean open, String status, String comment,
      Map<String, String> date, Double take_profit_price, Double stop_loss_price,
      boolean hitStopLoss,
      boolean hitTakeProfit) {
  ...
  public NewPositionEntity(String id) {
    this.id = id;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewPositionEntity that = (NewPositionEntity) o;
