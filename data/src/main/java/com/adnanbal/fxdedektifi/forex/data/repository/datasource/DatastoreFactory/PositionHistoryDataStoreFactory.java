...
import com.adnanbal.fxdedektifi.forex.data.net.RestApiPositionHistory;
import com.adnanbal.fxdedektifi.forex.data.net.RestApiPositionHistoryImpl;
import com.adnanbal.fxdedektifi.forex.data.repository.datasource.Cloud.CloudPositionHistoryDataStore;
import com.adnanbal.fxdedektifi.forex.data.repository.datasource.Datastore.PositionHistoryDataStore;
import com.adnanbal.fxdedektifi.forex.data.repository.datasource.Disk.DiskPositionHistoryDataStore;
...
public class PositionHistoryDataStoreFactory {
   ...
   */
  public PositionHistoryDataStore create(String positionId) {
