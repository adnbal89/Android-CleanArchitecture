...
import com.adnanbal.fxdedektifi.forex.data.repository.datasource.DatastoreFactory.PositionHistoryDataStoreFactory;
...
public class PositionHistoryDataRepository implements PositionHistoryRepository {
  ...
  @Override
  public Observable<Position> getOneCLosedPosition(String positionId) {
    final PositionHistoryDataStore positionDataStore = this.positionHistoryDataStoreFactory
        .create(positionId);
