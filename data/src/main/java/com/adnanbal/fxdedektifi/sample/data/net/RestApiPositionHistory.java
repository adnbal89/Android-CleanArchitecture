...
public interface RestApiPositionHistory {
   ...
   */
  String API_URL_GET_POSITION_LIST = API_BASE_URL + "positionHistory" + "?_sort=id&_order=desc";
  /**
   ...
   */
  Observable<PositionEntity> positionHistoryEntityById(final int positionId);
